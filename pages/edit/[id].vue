<template>
    <form>
        <div class="grid gap-4 grid-cols-4">
            <div class="space-y-8 rounded-lg bg-slate-300 p-8">
                <div>
                    <label for="name" class="block">Name</label>
                    <input class="rounded-lg bg-slate-400 p-2.5" id="name" v-model="name">
                </div>
                <div>
                    <label for="artist" class="block">Artist</label>
                    <input class="rounded-lg bg-slate-400 p-2.5" id="artist" v-model="artist">
                </div>
                <div>
                    <label for="key" class="block">Key</label>
                    <input class="rounded-lg bg-slate-400 p-2.5" id="key" v-model="key">
                </div>
            </div>
            <div class="col-span-3 space-y-4">
                <textarea class="p-8 w-full rounded-lg bg-slate-300 font-mono" v-model="content"></textarea>
